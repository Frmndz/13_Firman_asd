...
public class StrukMain13{
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Stack<Struk13> stack = new Stack<>();
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Struk13 struk = new Struk13(nomorTransaksi, tanggalPembelian, jumlahBarang, totalHargaBayar);
            stack.push(struk);
        }
        System.out.println("====================================");
        ...
        System.out.println("=======================================================");
        for (int i = 0; i < 5; i++) {
            Struk13 strukDitukar = stack.pop();
